...
export const bttnPreviousHabitMonth = document.getElementById('month-switcher-left');
export const bttnNextHabitMonth     = document.getElementById('month-switcher-right');
